...
<a>Имя </a><input type="TEXT" id = "name" name="name">  <br>
<a>Фамилия </a><input type="TEXT" id = "surname" name="surname"> <br>
<a>Имя Фамилия тренера </a><input type="TEXT" id = "coacher" name="coacher"> <br>
<a>Возраст </a><input type="TEXT" id = "age" name="age"> <br>
<a>Дистанция</a>
